...
class ProfilesTab(UiProfilesTab):
    ...
    @staticmethod
    def gr_to_g(cur_val):
        # print('gr_to_g', cur_val * 0.06479891, math.floor(cur_val * 0.06479891 * 100) / 100)
        # return math.floor(cur_val * 0.06479891 * 100) / 100
        return round(cur_val * 0.06479891, 2)

    @staticmethod
    def g_to_gr(cur_val):
        # print('g_to_gr', cur_val / 0.06479891, math.ceil(cur_val / 0.06479891 * 10) / 10)
        # return math.ceil(cur_val / 0.06479891 * 10) / 10
