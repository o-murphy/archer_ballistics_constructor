...
class Ui_filter(object):
    def setupUi(self, filter):
        ...
        self.resetFilter.setStyleSheet("background-color: rgb(40, 40, 40);")
        self.resetFilter.setObjectName("resetFilter")
        self.gridLayout.addWidget(self.resetFilter, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.caliber, 2, 1, 1, 1)
