...
class Ui_DragFuncEditDialog(object):
    def setupUi(self, DragFuncEditDialog):
        ...
        self.dfComment = QtWidgets.QLabel(self.dragTableToolBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dfComment.sizePolicy().hasHeightForWidth())
        self.dfComment.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, DragFuncEditDialog):
        ...
        self.dfComment.setText(_translate("DragFuncEditDialog", "Default G1 Draf-function"))
