...
class DrugFuncEditDialog(QtWidgets.QDialog, Ui_DrugFuncEdit):
    def __init__(self, data=None):
        ...
        self.drag_plot = DrugPlot('drag_plot')
        self.drop_plot = DrugPlot('drop_plot')

        self.gridLayout.addWidget(self.drop_plot, 0, 0, 1, 4)
        self.gridLayout.addWidget(self.drag_plot, 0, 0, 1, 4)
