...
"            QRadioButton {font-size: 15px;}")
        ...
        self.bc = QtWidgets.QDoubleSpinBox(self.bulletGroupBox)
        self.bc.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.gridLayout_4.addWidget(self.bc, 5, 1, 1, 1)
        ...
        self.weighQuantity = QtWidgets.QComboBox(self.horizontalWidget_17)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.weighQuantity.sizePolicy().hasHeightForWidth())
        self.weighQuantity.setSizePolicy(sizePolicy)
        self.weighQuantity.setMinimumSize(QtCore.QSize(30, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.weighQuantity.setFont(font)
        self.weighQuantity.setObjectName("weighQuantity")
        self.weighQuantity.addItem("")
        self.weighQuantity.addItem("")
        self.horizontalLayout_51.addWidget(self.weighQuantity)
...
"alternate-background-color: rgb(40, 40, 40);")
    ...
    def retranslateUi(self, profileCurrent):
        ...
        self.weighQuantity.setStyleSheet(_translate("profileCurrent", "background-color: rgb(40, 40, 40);"))
        self.weighQuantity.setItemText(0, _translate("profileCurrent", "Grains"))
        self.weighQuantity.setItemText(1, _translate("profileCurrent", "Grams"))
