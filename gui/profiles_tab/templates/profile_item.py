...
class Ui_profileItem(object):
    def setupUi(self, profileItem):
        ...
        self.tile.setMinimumSize(QtCore.QSize(40, 40))
        self.tile.setMaximumSize(QtCore.QSize(42, 42))
        font = QtGui.QFont()
        ...
        self.caliberShort.setMinimumSize(QtCore.QSize(40, 0))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Light Condensed")
        ...
        self.weightTile.setMinimumSize(QtCore.QSize(40, 0))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Light Condensed")
