...
class Ui_profilesTools(object):
    def setupUi(self, profilesTools):
        ...
        self.loadBookMark.setMaximumSize(QtCore.QSize(30, 30))
        ...
        self.loadBookMark.setIconSize(QtCore.QSize(20, 20))
...
"QPushButton::QToolTip {color: black}")
    ...
    def retranslateUi(self, profilesTools):
        ...
        self.loadBookMark.setToolTip(_translate("profilesTools", "Save to database"))
