...
class Ui_profilesTools(object):
    def setupUi(self, profilesTools):
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(profilesTools)
        ...
        self.horizontalLayout.addWidget(self.upProfile)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable/copybtn21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable-xhdpi-v4/savebtn_menu21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable-xhdpi-v4/saveasbtn_menu21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable/openbtn_menu21b.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.horizontalLayout.addWidget(self.closeFile)
...
"QPushButton::QToolTip {color: black}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable/addnewbtn21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.newProfileButton.setIcon(icon6)
        self.newProfileButton.setIconSize(QtCore.QSize(25, 25))
        self.newProfileButton.setObjectName("newProfileButton")
        self.horizontalLayout.addWidget(self.newProfileButton)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable/removebtn_menu21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.removeProfileButton.setIcon(icon7)
        self.removeProfileButton.setIconSize(QtCore.QSize(25, 25))
        self.removeProfileButton.setObjectName("removeProfileButton")
        self.horizontalLayout.addWidget(self.removeProfileButton)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("ui_templates\\.rsrc/res/drawable-xxxhdpi-v4/deletebtn21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.horizontalLayout.addWidget(self.clearAllProfiles)
        ...
        self.horizontalLayout.addWidget(self.saveProfileButton)
