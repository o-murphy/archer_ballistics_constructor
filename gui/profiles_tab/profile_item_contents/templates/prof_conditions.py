...
class Ui_conditions(object):
    def setupUi(self, conditions):
        ...
        self.lToolButton_29 = QtWidgets.QToolButton(self.widget_39)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lToolButton_29.sizePolicy().hasHeightForWidth())
        self.lToolButton_29.setSizePolicy(sizePolicy)
        self.lToolButton_29.setMaximumSize(QtCore.QSize(23, 23))
        self.lToolButton_29.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ui_templates\\../.rsrc/res/drawable/arrowrlbtn21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lToolButton_29.setIcon(icon)
        self.lToolButton_29.setObjectName("lToolButton_29")
        self.horizontalLayout_55.addWidget(self.lToolButton_29)
        self.rToolButton_29 = QtWidgets.QToolButton(self.widget_39)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rToolButton_29.sizePolicy().hasHeightForWidth())
        self.rToolButton_29.setSizePolicy(sizePolicy)
        self.rToolButton_29.setMaximumSize(QtCore.QSize(23, 23))
        self.rToolButton_29.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ui_templates\\../.rsrc/res/drawable/arrowlrbtn21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rToolButton_29.setIcon(icon1)
        self.rToolButton_29.setObjectName("rToolButton_29")
        self.horizontalLayout_55.addWidget(self.rToolButton_29)
