...
class Ui_bullet(object):
    def setupUi(self, bullet):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons19/res/drawable-xhdpi-v4/addbtn_menu21a.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addDrag.setIcon(icon)
        ...
        self.dfDataEditor = QtWidgets.QPushButton(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dfDataEditor.sizePolicy().hasHeightForWidth())
        self.dfDataEditor.setSizePolicy(sizePolicy)
        self.dfDataEditor.setMinimumSize(QtCore.QSize(60, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.dfDataEditor.setFont(font)
        icon2 = QtGui.QIcon()
        ...
        self.dfDataEditor.setIcon(icon2)
        self.dfDataEditor.setObjectName("dfDataEditor")
        self.gridLayout_4.addWidget(self.dfDataEditor, 4, 5, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.dragEditor, 5, 4, 1, 2)
    ...
    def retranslateUi(self, bullet):
        ...
        self.dfDataEditor.setToolTip(_translate("bullet", "<font color=black>Edit drag function</font>"))
        self.dfDataEditor.setText(_translate("bullet", "Edit"))
        self.dragEditor.setToolTip(_translate("bullet", "<font color=black>Edit drag function</font>"))
        self.dragEditor.setText(_translate("bullet", "Drag function editor"))
import res_rc
