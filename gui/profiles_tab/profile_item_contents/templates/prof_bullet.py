...
class Ui_bullet(object):
    def setupUi(self, bullet):
        ...
        self.dragEditor.setMinimumSize(QtCore.QSize(200, 0))
        self.dragEditor.setObjectName("dragEditor")
        self.gridLayout_4.addWidget(self.dragEditor, 5, 4, 1, 2)
        self.dfDataEditor = QtWidgets.QToolButton(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dfDataEditor.setIcon(icon1)
        self.dfDataEditor.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
