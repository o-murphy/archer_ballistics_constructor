...
class Ui_bullet(object):
    def setupUi(self, bullet):
        ...
        self.proDragEdit = QtWidgets.QPushButton(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.proDragEdit.sizePolicy().hasHeightForWidth())
        self.proDragEdit.setSizePolicy(sizePolicy)
        self.proDragEdit.setMinimumSize(QtCore.QSize(130, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.proDragEdit.setFont(font)
        self.proDragEdit.setAutoDefault(False)
        self.proDragEdit.setDefault(False)
        self.proDragEdit.setFlat(False)
        ...
        self.dragEditor.setMinimumSize(QtCore.QSize(85, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.gridLayout_4.addWidget(self.dragEditor, 5, 3, 1, 1)
    ...
    def retranslateUi(self, bullet):
        ...
        self.proDragEdit.setText(_translate("bullet", "Advanced mode"))
