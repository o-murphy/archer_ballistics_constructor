...
class Ui_catalogBullet(object):
    def setupUi(self, catalogBullet):
        ...
        self.dragEditor_3 = QtWidgets.QToolButton(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dragEditor_3.sizePolicy().hasHeightForWidth())
        self.dragEditor_3.setSizePolicy(sizePolicy)
        self.dragEditor_3.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.dragEditor_3.setFont(font)
        icon = QtGui.QIcon()
        ...
        self.dragEditor_3.setIcon(icon)
        self.dragEditor_3.setObjectName("dragEditor_3")
        self.gridLayout_4.addWidget(self.dragEditor_3, 7, 1, 1, 1)
        ...
        self.dragEditor_2 = QtWidgets.QToolButton(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dragEditor_2.sizePolicy().hasHeightForWidth())
        self.dragEditor_2.setSizePolicy(sizePolicy)
        self.dragEditor_2.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.dragEditor_2.setFont(font)
        self.dragEditor_2.setIcon(icon)
        self.dragEditor_2.setObjectName("dragEditor_2")
        self.gridLayout_4.addWidget(self.dragEditor_2, 8, 1, 1, 1)
        self.weight_2 = QtWidgets.QDoubleSpinBox(self.bulletGroupBox)
        ...
        self.weight_2.setMinimumSize(QtCore.QSize(80, 0))
        self.weight_2.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.weight_2.setFont(font)
        self.weight_2.setDecimals(2)
        self.weight_2.setMaximum(1000.0)
        self.weight_2.setSingleStep(0.01)
        self.weight_2.setProperty("value", 69.0)
        self.weight_2.setObjectName("weight_2")
        self.gridLayout_4.addWidget(self.weight_2, 4, 1, 1, 1)
        ...
        self.label_84 = QtWidgets.QLabel(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.label_84, 10, 2, 1, 1)
        self.weight_5 = QtWidgets.QDoubleSpinBox(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.weight_5.sizePolicy().hasHeightForWidth())
        self.weight_5.setSizePolicy(sizePolicy)
        self.weight_5.setMinimumSize(QtCore.QSize(80, 0))
        self.weight_5.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.weight_5.setFont(font)
        self.weight_5.setDecimals(2)
        self.weight_5.setMaximum(1000.0)
        self.weight_5.setSingleStep(0.01)
        self.weight_5.setProperty("value", 69.0)
        self.weight_5.setObjectName("weight_5")
        self.gridLayout_4.addWidget(self.weight_5, 6, 1, 1, 1)
        self.label_87 = QtWidgets.QLabel(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.label_87, 8, 2, 1, 1)
        self.label_86 = QtWidgets.QLabel(self.bulletGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.label_86, 7, 2, 1, 1)
    ...
    def retranslateUi(self, catalogBullet):
        ...
        self.dragEditor_3.setToolTip(_translate("catalogBullet", "<font color=black>Edit drag function</font>"))
        self.dragEditor_3.setText(_translate("catalogBullet", "Setup"))
        ...
        self.dragEditor_2.setToolTip(_translate("catalogBullet", "<font color=black>Edit drag function</font>"))
        self.dragEditor_2.setText(_translate("catalogBullet", "Setup"))
        ...
        self.label_84.setText(_translate("catalogBullet", "DFL:"))
        self.label_87.setText(_translate("catalogBullet", "Points: 0"))
        self.label_86.setText(_translate("catalogBullet", "Points: 0"))
