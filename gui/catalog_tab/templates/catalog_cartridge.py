...
class Ui_catalogCartridge(object):
    def setupUi(self, catalogCartridge):
        ...
        catalogCartridge.setMinimumSize(QtCore.QSize(412, 188))
        catalogCartridge.setMaximumSize(QtCore.QSize(412, 188))
        ...
        self.gridLayout.addWidget(self.cartridgeName, 0, 1, 1, 1)
        ...
        self.horizontalWidget_16 = QtWidgets.QWidget(catalogCartridge)
        ...
        self.gridLayout.addWidget(self.horizontalWidget_16, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.bullet, 5, 1, 1, 1)
