...
class Ui_catalogCartridge(object):
    def setupUi(self, catalogCartridge):
        ...
        catalogCartridge.resize(412, 188)
        catalogCartridge.setMaximumSize(QtCore.QSize(16777215, 188))
        ...
        self.bullet = QtWidgets.QComboBox(self.cartridgeGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.bullet, 6, 1, 1, 1)
        self.caliber = QtWidgets.QComboBox(self.cartridgeGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
