...
class ClickCalc(QtWidgets.QDialog):
    ...
    def setupUI(self):
        ...
        self.label_crx = QtWidgets.QLabel('Core horizontal resolution:')
        self.label_cry = QtWidgets.QLabel('Core vertical resolution:')
        self.label_pxs = QtWidgets.QLabel('Core pixel size (um):')
        self.label_lf = QtWidgets.QLabel('Lens focus:')
        self.label_orx = QtWidgets.QLabel('Output horizontal resolution')
        self.label_ory = QtWidgets.QLabel('Output vertical resolution:')

        self.gridLayout.addWidget(self.label_crx, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.label_cry, 1, 0, 1, 1)
        self.gridLayout.addWidget(self.label_pxs, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.label_lf, 3, 0, 1, 1)
        self.gridLayout.addWidget(self.label_orx, 4, 0, 1, 1)
        self.gridLayout.addWidget(self.label_ory, 5, 0, 1, 1)
