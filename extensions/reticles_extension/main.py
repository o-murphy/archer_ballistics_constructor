...
class EmptyTab(QWidget, Ui_ReticlesTab):
    ...
    def __init__(self, main_window):
        ...
        t_size_policy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.table.setSizePolicy(t_size_policy)
    ...
    def load_templates(self):
        ...
        print(XROOT_PATH + r'\reticle_templates')
        files = os.listdir(XROOT_PATH + r'\reticle_templates')
        templates = [f for f in files if f.endswith('.json')]
        for t in templates:
            with open(XROOT_PATH + fr'\reticle_templates\{t}', 'r') as fp:
                data = json.load(fp)
    ...
    def retranslateUi(self, ReticlesTab):
        ...
        self.translator.load(XROOT_PATH + fr'\translate\eng-{lang}.qm')
        app.installTranslator(self.translator)

        _translate = QCoreApplication.translate
        self.btn.setText(_translate('ReticlesTab', 'Zoom'))
        self.item_adder.setText(_translate('ReticlesTab', 'Add'))
        self.edit_click.setText(_translate('ReticlesTab', 'Click Calculator'))
        self.mk_reticle2_x4.setText(_translate('ReticlesTab', 'Create 4-zoom reticle2'))
        self.grid_on.setText(_translate('ReticlesTab', 'Enable grid'))
        self.table.table_model.setHorizontalHeaderLabels([
            _translate('ReticlesTab', 'Type'),
            _translate('ReticlesTab', 'Mode'),
            _translate('ReticlesTab', 'Min zoom'),
            _translate('ReticlesTab', 'Max zoom'),
